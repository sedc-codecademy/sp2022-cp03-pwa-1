import { sessionCardButtons, sessionModals,closeButton,overlayDiv,startButton,cardContainer,sessionCardBodyDiv,sessionCardButtonSetting,
  ...
  selectionFieldPace,saveTaskButton,listOfTasks,taskPriority, taskPace,cancelTaskButton,endSessionButton,clearTaskButton } from './Variables/selectors.js';

import {initialTaskTime, taskTimeLeftWhenStopped,     timenow, 
        isSessionActive, startSessionTime, arrayOfTasks, arrayOfFinishedTasks, session} from './Variables/globalVariables.js';
